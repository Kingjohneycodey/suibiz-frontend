                    ...
                    <div className="flex space-x-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 rounded-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                value={searchTerm}
                                ...
                                currentProducts.map((product: Product) => (
                                    <tr key={product.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <Link href={`/business/product-upload?id=${product.id}`} className="text-blue-600 hover:text-blue-900 mr-4">
                                                <button
