            ...
            <div className="p-4 md:p-6 min-h-screen">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 md:p-6 mb-6">
                    ...
                    <div className="relative flex-grow max-w-md">
                        ...
                        <input
                        type="text"
                        className="block w-full pl-10 pr-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg leading-5 bg-white dark:bg-gray-700 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm dark:text-gray-100"
                    ...
                    <div className="flex items-center">
                        ...
                        <select
                        className="block w-full pl-3 pr-10 py-2 text-sm border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-lg bg-white dark:bg-gray-700 dark:text-gray-100"
                        value={statusFilter}
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        {filteredOrders.map((order) => (
                            ...
                            <td className="px-4 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                ...
                                <select
                                className="border-0 bg-transparent text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded text-sm dark:bg-gray-700"
                                value={order.status}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                        ...
                        <div className="overflow-y-auto px-6 pt-6 pb-4">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700 p-5 rounded-lg">
                                ...
                                <h4 className="text-base font-semibold text-gray-900 dark:text-gray-100">Customer Information</h4>
                                </div>
                                <div className="space-y-3">
                                <div>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Name</p>
                                    <p className="text-sm font-medium dark:text-gray-200">{selectedOrder.customerName}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Email</p>
                                    <p className="text-sm font-medium dark:text-gray-200">{selectedOrder.email}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Phone</p>
                                    <p className="text-sm font-medium dark:text-gray-200">{selectedOrder.phone}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Address</p>
                                    <p className="text-sm font-medium dark:text-gray-200">{selectedOrder.address}</p>
                                </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700 p-5 rounded-lg">
                                ...
                                <h4 className="text-base font-semibold text-gray-900 dark:text-gray-100">Order Summary</h4>
                                </div>
                                <div className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <p className="text-sm font-medium dark:text-gray-200">{selectedOrder.paymentMethod}</p>
                                </div>
                                <div className="flex justify-between">
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Total Amount</p>
                                    <p className="text-sm font-medium dark:text-gray-200">${selectedOrder.total.toFixed(2)}</p>
                                </div>
                                </div>
                            </div>
                            </div>
                            ...
                            <div className="mt-8">
                            <h4 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-4">Order Items</h4>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-t border-gray-200 dark:border-gray-600 flex justify-end">
                            <button
                            type="button"
                            className="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                            onClick={closeModal}
                            >
                            Close
                            </button>
