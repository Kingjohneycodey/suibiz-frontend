                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <input
                            type="text"
                            placeholder="Search..."
                            className="w-64 py-2 pl-10 pr-4 rounded-lg bg-gray-100 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300 hidden md:inline">John Doe</span>
                        </button>
            ...
            <div className="px-4 pb-4 md:hidden">
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full py-2 pl-10 pr-4 rounded-lg bg-gray-100 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
            </div>
        </header>
