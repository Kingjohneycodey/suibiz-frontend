        ...
        <div className="space-y-6 sm:p-6 max-w-7xl mx-auto dark:bg-gray-900 ">
            ...
            <div className="bg-gradient-to-r from-purple-900 to-indigo-700 p-6 rounded-xl shadow-lg text-white">
                ...
                <div>
                    ...
                    <p className="text-3xl font-bold mt-1">{balance.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</p>
                    <p className="text-sm opacity-80 mt-2">Equivalent to {(balance / 1.25).toFixed(2)} SUI</p>
                </div>
